        ...
        <form method='post' action='<?php echo base_url('register/store'); ?>' >
          <div class="mb-5"> 
            ...
            <div class="col-sm-6">
                <!-- Form -->
                <div class="mb-4">
                  <label class="form-label" for="listingAgentNameUploadForm">Name <font color='red'>*</font></label>
                  
                  <div class="input-group input-group-merge">
                    <span class="input-group-prepend input-group-text">
                        <i class="far fa-envelope"></i>
                    </span>
                    <input type="text" name='name' class="form-control form-control-lg" id="listingAgentNameUploadForm" placeholder="Name" >
                  </div>
                </div>
                <!-- End Form -->
              </div>
              ...
              <div class="col-sm-6">
                <!-- Form -->
                <div class="mb-4">
                  <label class="form-label" for="listingAgentNameUploadForm">Mobile <font color='red'>*</font></label>
                  
                  <div class="input-group input-group-merge">
                    <span class="input-group-prepend input-group-text">
                        <i class="far fa-envelope"></i>
                    </span>
                    <input type="text" name='mobile' class="form-control form-control-lg" id="listingAgentNameUploadForm" placeholder="Mobile" >
                  </div>
                </div>
                <!-- End Form -->
              </div>
